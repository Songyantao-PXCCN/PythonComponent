...
int variablesParse(PyObject* PyO_variables, const char* prefix,std::vector<String>& varNames,int& offset)
{
    varNames.clear();
...
// template<typename T>
// PyObject* ArpBytesBuild(const T &Variable,bool endianConvert )
// {
...
// template<typename T>
// int ArpBytesParse(PyObject* Bytes,T &Variable,bool endianConvert )
// {
...
// template<typename T>
// PyObject* ArpByteArrayBuild(const T &Variable,bool endianConvert )
// {
...
// template<typename T>
// int ArpByteArrayParse(PyObject* ByteArray,T &Variable,bool endianConvert )
// {
...
// // extern "C" {
// // #endif
// // int xPyArg_Parse(PyObject *, const char *, ...);
// // int xPyArg_ParseTuple(PyObject *, const char *, ...);
// // int xPyArg_VaParse(PyObject *, const char *, va_list);

// int xPyArg_ParseTupleAndKeywords(PyObject *, PyObject *,
//                                 const char *, char **, ...);
// // int xPyArg_VaParseTupleAndKeywords(PyObject *, PyObject *,
// //                                 const char *, char **, va_list);

// // int x_PyArg_ParseTupleAndKeywordsFast(PyObject *, PyObject *,
// //                                             struct _PyArg_Parser *, ...);
// // int x_PyArg_VaParseTupleAndKeywordsFast(PyObject *, PyObject *,
...
// // static int xvgetargs1(PyObject *, const char *, va_list *, int);
...
// // int xPyArg_Parse(PyObject *args, const char *format, ...)
// // {
// //     int retval;
// //     va_list va;

// //     va_start(va, format);
// //     retval = xvgetargs1(args, format, &va, FLAG_COMPAT);
// //     va_end(va);
// //     return retval;
// // }

// // int x_PyArg_Parse_SizeT(PyObject *args, const char *format, ...)
// // {
// //     int retval;
// //     va_list va;

// //     va_start(va, format);
// //     retval = xvgetargs1(args, format, &va, FLAG_COMPAT|FLAG_SIZE_T);
// //     va_end(va);
// //     return retval;
// // }


// // int xPyArg_ParseTuple(PyObject *args, const char *format, ...)
// // {
// //     int retval;
// //     va_list va;

// //     va_start(va, format);
// //     retval = xvgetargs1(args, format, &va, 0);
// //     va_end(va);
// //     return retval;
// // }

// // int x_PyArg_ParseTuple_SizeT(PyObject *args, const char *format, ...)
// // {
// //     int retval;
// //     va_list va;

// //     va_start(va, format);
// //     retval = xvgetargs1(args, format, &va, FLAG_SIZE_T);
// //     va_end(va);
// //     return retval;
// // }


// // int x_PyArg_ParseStack(PyObject *const *args, Py_ssize_t nargs, const char *format, ...)
// // {
// //     int retval;
// //     va_list va;
...
// // int x_PyArg_ParseStack_SizeT(PyObject *const *args, Py_ssize_t nargs, const char *format, ...)
// // {
// //     int retval;
// //     va_list va;
...
// // int xPyArg_VaParse(PyObject *args, const char *format, va_list va)
// // {
// //     va_list lva;
// //     int retval;
...
// //     retval = xvgetargs1(args, format, &lva, 0);
// //     va_end(lva);
// //     return retval;
// // }

// // int x_PyArg_VaParse_SizeT(PyObject *args, const char *format, va_list va)
// // {
// //     va_list lva;
// //     int retval;
...
// //     retval = xvgetargs1(args, format, &lva, FLAG_SIZE_T);
// //     va_end(lva);
// //     return retval;
// // }
...
// static int cleanup_ptr(PyObject *self, void *ptr)
// {
//     if (ptr) {
//         PyMem_FREE(ptr);
//     }
...
// static int cleanup_buffer(PyObject *self, void *ptr)
// {
...
// // static int vgetargs1_impl(PyObject *compat_args, PyObject *const *stack, Py_ssize_t nargs, const char *format,
// //                va_list *p_va, int flags)
// // {
// //     char msgbuf[256];
// //     int levels[32];
...
// // static int xvgetargs1(PyObject *args, const char *format, va_list *p_va, int flags)
// // {
// //     PyObject **stack;
// //     Py_ssize_t nargs;
...
//     static void seterror(Py_ssize_t iarg, const char *msg, int *levels, const char *fname, const char *message)
//     {
//         char buf[512];
//         int i;
//         char *p = buf;
...
//             }
//             if (iarg != 0) {
//                 PyOS_snprintf(p, sizeof(buf) - (p - buf),"argument %" PY_FORMAT_SIZE_T "d", iarg);
//                 i = 0;
//                 p += strlen(p);
...
//     static const char * converttuple(PyObject *arg, const char **p_format, va_list *p_va, int flags,
...
//     static const char * convertitem(PyObject *arg, const char **p_format, va_list *p_va, int flags,int *levels, char *msgbuf, size_t bufsize, freelist_t *freelist)
//     {
//         const char *msg;
//         const char *format = *p_format;
...
//         if (*format == '(' /* ')' */) {
//             format++;
//             msg = converttuple(arg, &format, p_va, flags, levels, msgbuf,bufsize, 0, freelist);
//             if (msg == NULL)
//                 format++;
//         }
//         else {
...
//     static const char * converterr(const char *expected, PyObject *arg, char *msgbuf, size_t bufsize)
//     {
...
// static const char * convertsimple(PyObject *arg, const char **p_format, va_list *p_va, int flags,char *msgbuf, size_t bufsize, freelist_t *freelist)
// {
//     /* For # codes */
...
//             Arp::System::Commons::Diagnostics::Logging::Log::Info("PyList_Check(*p) ->{}",PyList_Check(*p)?"True":"False");
// #endif
...
// static Py_ssize_t convertbuffer(PyObject *arg, const void **p, const char **errmsg)
// {
...
// int xPyArg_ParseTupleAndKeywords(PyObject *args,PyObject *keywords,const char *format,char **kwlist, ...)
// {
//     int retval;
//     va_list va;

//     if ((args == NULL || !PyTuple_Check(args)) || (keywords != NULL && !PyDict_Check(keywords)) || format == NULL || kwlist == NULL)
//     {
//         PyErr_BadInternalCall();
//         return 0;
//     }
...
// // int x_PyArg_ParseTupleAndKeywords_SizeT(PyObject *args,
// //                                 PyObject *keywords,
// //                                 const char *format,
// //                                 char **kwlist, ...)
// // {
...
// // int xPyArg_VaParseTupleAndKeywords(PyObject *args,
// //                               PyObject *keywords,
// //                               const char *format,
...
// // int _PyArg_VaParseTupleAndKeywords_SizeT(PyObject *args,
// //                                     PyObject *keywords,
// //                                     const char *format,
// //                                     char **kwlist, va_list va)
// // {
...
// // int x_PyArg_ParseTupleAndKeywordsFast(PyObject *args, PyObject *keywords,
// //                             struct _PyArg_Parser *parser, ...)
// // {
// //     int retval;
// //     va_list va;
...
// // int x_PyArg_ParseTupleAndKeywordsFast_SizeT(PyObject *args, PyObject *keywords,
// //                             struct _PyArg_Parser *parser, ...)
// // {
// //     int retval;
// //     va_list va;
...
// // int x_PyArg_ParseStackAndKeywords(PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames,
// //                   struct _PyArg_Parser *parser, ...)
// // {
// //     int retval;
// //     va_list va;
...
// // int x_PyArg_ParseStackAndKeywords_SizeT(PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames,
// //                         struct _PyArg_Parser *parser, ...)
// // {
// //     int retval;
// //     va_list va;
...
// // int x_PyArg_VaParseTupleAndKeywordsFast(PyObject *args, PyObject *keywords,
...
// // int x_PyArg_VaParseTupleAndKeywordsFast_SizeT(PyObject *args, PyObject *keywords,
// //                             struct _PyArg_Parser *parser, va_list va)
// // {
// //     int retval;
// //     va_list lva;
...
// // int xPyArg_ValidateKeywordArguments(PyObject *kwargs)
// // {
...
// static int vgetargskeywords(PyObject *args, PyObject *kwargs, const char *format,char **kwlist, va_list *p_va, int flags)
// {
//     char msgbuf[512];
//     int levels[32];
...
//             if (current_arg) {
//                 msg = convertitem(current_arg, &format, p_va, flags,levels, msgbuf, sizeof(msgbuf), &freelist);
//                 if (msg) {
...
//             {
//                 #ifdef ARG_DEBUG
//                 Arp::System::Commons::Diagnostics::Logging::Log::Info("current_arg = NULL;");
//                 #endif
//             }
...
//                 #ifdef ARG_DEBUG
//                 Arp::System::Commons::Diagnostics::Logging::Log::Info("Finish_1");
//                 #endif
...
// // static void parser_clear(struct _PyArg_Parser *parser)
// // {
// //     Py_CLEAR(parser->kwtuple);
// // }

// // static PyObject* find_keyword(PyObject *kwargs, PyObject *kwnames, PyObject *const *kwstack, PyObject *key)
// // {
...
//     return NULL;
// }
// // static int unpack_stack(PyObject *const *args, Py_ssize_t nargs, const char *name,
